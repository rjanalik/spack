...
# spack solve
set -g __fish_spack_optspecs_spack_solve h/help show= l/long L/very-long N/namespaces I/install-status no-install-status d/debug-nondefaults y/yaml j/json c/cover= t/types timers stats U/fresh reuse reuse-deps
...
# spack spec
set -g __fish_spack_optspecs_spack_spec h/help l/long L/very-long N/namespaces I/install-status no-install-status d/debug-nondefaults y/yaml j/json format= c/cover= t/types U/fresh reuse reuse-deps
